...
public class DEBJResultListActivity extends AppCompatActivity {
    ...
    class ResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType==0){
                return new ResultHeaderHolder(LayoutInflater.from(DEBJResultListActivity.this).inflate(R.layout.debj_header_layout,parent,false));
            }else {
                return new ResultHolder(LayoutInflater.from(DEBJResultListActivity.this).inflate(R.layout.debj_layout,parent,false));
            }
        }
